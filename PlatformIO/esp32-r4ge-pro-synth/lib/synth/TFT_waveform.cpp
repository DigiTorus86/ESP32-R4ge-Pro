...
void TFT_waveform::draw(Adafruit_ILI9341 *tft, SYN_wave_type wave_type)
{
    switch (wave_type)
    {
        case SYN_WAVE_SINE:
...
void TFT_waveform::drawName(Adafruit_ILI9341 *tft, SYN_wave_type wave_type)
{
    //tft->setTextSize(1);
 ...
 */
void TFT_waveform::drawSilence(Adafruit_ILI9341 *tft)
{
 ...
 */
void TFT_waveform::drawSine(Adafruit_ILI9341 *tft)
{
...
void TFT_waveform::drawSquare(Adafruit_ILI9341 *tft)
{
...
void TFT_waveform::drawMinor(Adafruit_ILI9341 *tft)
{
    tft->setTextSize(2);
    tft->setTextColor(_wave_color);
    tft->setCursor((_x + _wd / 2) - 6, _ctr_y - 6); 
...
void TFT_waveform::drawOct3(Adafruit_ILI9341 *tft)
{
    tft->setTextSize(2);
    tft->setTextColor(_wave_color);
    tft->setCursor((_x + _wd / 2) - 6, _ctr_y - 6); 
...
void TFT_waveform::drawCustom(Adafruit_ILI9341 *tft)
{
    tft->setTextSize(2);
    tft->setTextColor(_wave_color);
    tft->setCursor((_x + _wd / 2) - 6, _ctr_y - 6); 
