...
// Currently open pins: 35 (input only)
...
#define SR_Q7     36  // Serial data out, SR pin 9

#define JOYX_L    39  // Left analog joystick X axis
#define JOYY_L    34  // Left analog joystick Y axis
#define JBTN_L    -1  // Left joystick button - Not Connected
#define JOYX_R    14  // Right analog joystick X axis
#define JOYY_R    12  // Right analog joystick Y axis
#define JBTN_R    -1  // Right joystick button - Not Connected

#define MIC       35  // Microphone analog signal, input only
